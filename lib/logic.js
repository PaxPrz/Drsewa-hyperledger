...
async function createPatient(detail){
    ...
    newPatient.year = detail.year;
    newPatient.month = detail.month;
    newPatient.date = detail.date;
...
async function createDoctor(detail){
    ...
    newDoctor.year = detail.year;
    newDoctor.month = detail.month;
    newDoctor.date = detail.date;
